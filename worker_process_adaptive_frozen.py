...
class PAS_Manager:
    def __init__(self, model, initial_iter_per_round, world_size, group):
        self.frag_shape_list = []
        self.frag_index_list = []
        self.group = group
        self.world_size = world_size
        self.sync_frequency = initial_iter_per_round
...
def run(world_size, rank, group, epoch_per_round, batch_size):
    ...
    pas_manager = PAS_Manager(model, 250*epoch_per_round, world_size, group)
    iter_id = 0
    epoch_id = 0
