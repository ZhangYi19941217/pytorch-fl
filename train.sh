...
do
	...
	nohup ssh $i "python /home/ubuntu/pytorch-fl/worker_process_adaptive_frozen.py --master_address='tcp://'$master':22222' --rank=$num --world_size=$world_size --model=$model --dataset=$dataset --iid=$iid" >/home/ubuntu/worker_$num.log 2>&1 &
